...
We want to display captions on our Image/Video Popups tailored the mood that a Popup belongs to. We'll upload our current `pack.yml` to [**EPSM**](https://dabberoo.github.io/epsm/) and add all three of our new moods.
