...
An easier way to create/edit a `pack.yml` file is to use [**Edgeware++ Pack Settings Maker (EPSM)**](https://dabberoo.github.io/epsm/). With **EPSM**, you can create a new `pack.yml` or you can upload a valid `pack.yml` and edit it with **EPSM**.
